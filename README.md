...
| 3.   | [Анализ текстов](https://github.com/Krasnov-Andrey/Portfolio/tree/main/Анализ%20текстов) | Анализ комментариев пользователей на токсичность             | python, pandas, numpy, nltk, sklearn, CatBoost |
